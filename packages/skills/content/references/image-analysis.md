...
当用户提供高保真的 UI 图像、截图、视觉稿或参考图，并希望实现相应的代码时，请参考此文件。
...
## 第十一步：将分析转化为可构建的结构 (Convert To Buildable Structure)
...
## 第十二步：在真实技术栈中实现 (Implement In The Real Stack)
