---
name: "life-design-system-pc"
description: "使用 @life-ds/components-web 构建或优化 PC 桌面端 React 后台界面。当需求涉及桌面端、后台、侧边栏、表格或宽屏页面时使用。"
---
...
5. **仅处理 PC 页面。** 本 Skill 只适用于桌面端后台、宽屏页面和桌面交互；移动端 H5、手机页面、底部导航、安全区或触屏交互必须改用 `life-design-system-mobile`。大部分 PC 页面遵循顶部导航、左侧菜单和中间内容区域的标准结构，基础框架请阅读 [reference/pages/pc.md](reference/pages/pc.md)。
...
- token样式：[../_shared/reference/foundations/tokens.md](../_shared/reference/foundations/tokens.md)
- 图标：[../_shared/reference/components/icon.md](../_shared/reference/components/icon.md)
- 颜色：[../_shared/reference/foundations/colors.md](../_shared/reference/foundations/colors.md)
...
本 Skill 仅处理 PC 页面。带顶部导航、左侧菜单和中间内容区域的桌面端后台页面，必须阅读 [reference/pages/pc.md](reference/pages/pc.md) 并使用其中的基础结构。
